...
class InternalsPluginV03 : public InternalsPluginV02  // V03 contains everything from V02 plus the following:
{
 ...
 public:
  ...
  virtual unsigned char WantsToViewVehicle( CameraControlInfoV01 &camControl ) { return( 3 ); } // return values: 0=do nothing, 1=set ID and camera type, 2=replay controls, 3=both
